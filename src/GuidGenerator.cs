#region ENBREA GUID.FACTORY - Copyright (C) 2023 STÜBER SYSTEMS GmbH
/*    
 *    ENBREA GUID.FACTORY
 *    
...
namespace Enbrea.GuidFactory
{
    /// <summary>
    /// Factory class for generating deterministic <see cref="Guid"/> values.
    /// </summary>
    /// <remarks>
    ...
    public static class GuidGenerator
    {
        ...
        public static Guid Create(Guid namespaceId, string name, int version)
        {
            ...
            // appropriate 4-bit version number from Section 4.1.3 (step 8)
        ...
        /// </summary>
        /// <param name="guid">GUID  as array of bytes</param>
        ...
        /// <summary>
        /// Swap byte values within a GUID array
        /// </summary>
        /// <param name="guid">GUID  as array of bytes</param>
